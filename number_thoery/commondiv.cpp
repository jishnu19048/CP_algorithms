...
void solve(){
    //very USEFUL METHOD better than O(rootn*n) where we check for every factor of every number
    //finding max common gcd using sieve type logic for checking factors of the number if they are in our input array
    int n; cin>>n;
    int arr[n];
