...
ll factorial[2000002];
void solve(){
    int a,b; cin>>a>>b;
    
    //place n-1 partitions between m apples, which in simple terms is
    //in how many ways can you arrange n-1 partitions and m apples?

    cout<<(factorial[a+b-1]*inv((factorial[b]*factorial[a-1])%mod))%mod<<endl;
